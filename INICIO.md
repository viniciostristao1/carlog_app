...
**v0.6.0 — NUVEM LIGADA + OCR** (`flutter analyze` limpo, 7 testes de consumo/previsão passando). Repositório GitHub
...
de data** da próxima revisão/itens; v0.5.0 **FIPE dentro do cadastro** + ícone maior; v0.6.0 **OCR do
